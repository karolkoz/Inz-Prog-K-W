...
/**
 * Base class that represents a row from the 'skladniki' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Skladniki implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\SkladnikiTableMap';
    ...
    /**
     * The value for the id_skladnik field.
     *
     * @var        int
     */
    protected $id_skladnik;
    ...
    /**
     * Compares this with another <code>Skladniki</code> instance.  If
     * <code>obj</code> is an instance of <code>Skladniki</code>, delegates to
     * <code>equals(Skladniki)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    /**
     * Get the [id_skladnik] column value.
     *
     * @return int
     */
    public function getIdSkladnik()
    {
    ...
    /**
     * Set the value of [id_skladnik] column.
     *
     * @param int $v New value
     * @return $this|\Skladniki The current object (for fluent API support)
     */
    public function setIdSkladnik($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->id_skladnik !== $v) {
            $this->id_skladnik = $v;
            $this->modifiedColumns[SkladnikiTableMap::COL_ID_SKLADNIK] = true;
        }
    ...
    public function setNazwa($v)
    {
        ...
        if ($this->nazwa !== $v) {
            $this->nazwa = $v;
            $this->modifiedColumns[SkladnikiTableMap::COL_NAZWA] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SkladnikiTableMap::translateFieldName('IdSkladnik', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_skladnik = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SkladnikiTableMap::translateFieldName('Nazwa', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = SkladnikiTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Skladniki'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSkladnikiQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Skladniki::setDeleted()
     * @see Skladniki::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSkladnikiQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SkladnikiTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SkladnikiTableMap::COL_ID_SKLADNIK)) {
            $modifiedColumns[':p' . $index++]  = 'id_skladnik';
        }
        if ($this->isColumnModified(SkladnikiTableMap::COL_NAZWA)) {
            $modifiedColumns[':p' . $index++]  = 'nazwa';
        }

        $sql = sprintf(
            'INSERT INTO skladniki (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id_skladnik':
                        $stmt->bindValue($identifier, $this->id_skladnik, PDO::PARAM_INT);
                        break;
                    case 'nazwa':
    ...
    {
        $pos = SkladnikiTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Skladniki'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Skladniki'][$this->hashCode()] = true;
        $keys = SkladnikiTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdSkladnik(),
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Skladniki The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SkladnikiTableMap::COL_ID_SKLADNIK)) {
            $criteria->add(SkladnikiTableMap::COL_ID_SKLADNIK, $this->id_skladnik);
        }
        if ($this->isColumnModified(SkladnikiTableMap::COL_NAZWA)) {
            $criteria->add(SkladnikiTableMap::COL_NAZWA, $this->nazwa);
        }
    ...
    {
        $criteria = ChildSkladnikiQuery::create();
        $criteria->add(SkladnikiTableMap::COL_ID_SKLADNIK, $this->id_skladnik);
    ...
    {
        $validPk = null !== $this->getIdSkladnik();
    ...
    /**
     * Generic method to set the primary key (id_skladnik column).
     *
    ...
    {
        return null === $this->getIdSkladnik();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Skladniki (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdSkladnik(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Skladniki Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildSkladniki is new, it will return
    ...
    {
        return (string) $this->exportTo(SkladnikiTableMap::DEFAULT_STRING_FORMAT);
    }
