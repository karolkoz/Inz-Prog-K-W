...
/**
 * Base class that represents a row from the 'lubie_to' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Lubie_to implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\Lubie_toTableMap';
    ...
    /**
     * Initializes internal state of Base\Lubie_to object.
     */
    ...
    /**
     * Compares this with another <code>Lubie_to</code> instance.  If
     * <code>obj</code> is an instance of <code>Lubie_to</code>, delegates to
     * <code>equals(Lubie_to)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     * @return $this|\Lubie_to The current object (for fluent API support)
     */
    public function setUzytkownikLogin($v)
    {
        ...
        if ($this->uzytkownik_login !== $v) {
            ...
            $this->modifiedColumns[Lubie_toTableMap::COL_UZYTKOWNIK_LOGIN] = true;
        }
    ...
    public function setPrzepisIdPrzepis($v)
    {
        ...
        if ($this->przepis_id_przepis !== $v) {
            ...
            $this->modifiedColumns[Lubie_toTableMap::COL_PRZEPIS_ID_PRZEPIS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : Lubie_toTableMap::translateFieldName('UzytkownikLogin', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uzytkownik_login = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : Lubie_toTableMap::translateFieldName('PrzepisIdPrzepis', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = Lubie_toTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Lubie_to'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildLubie_toQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Lubie_to::setDeleted()
     * @see Lubie_to::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildLubie_toQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                Lubie_toTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(Lubie_toTableMap::COL_UZYTKOWNIK_LOGIN)) {
            $modifiedColumns[':p' . $index++]  = 'UZYTKOWNIK_login';
        }
        if ($this->isColumnModified(Lubie_toTableMap::COL_PRZEPIS_ID_PRZEPIS)) {
            $modifiedColumns[':p' . $index++]  = 'PRZEPIS_id_przepis';
        }

        $sql = sprintf(
            'INSERT INTO lubie_to (%s) VALUES (%s)',
    ...
    {
        $pos = Lubie_toTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Lubie_to'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Lubie_to'][$this->hashCode()] = true;
        $keys = Lubie_toTableMap::getFieldNames($keyType);
        $result = array(
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Lubie_to The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(Lubie_toTableMap::COL_UZYTKOWNIK_LOGIN)) {
            $criteria->add(Lubie_toTableMap::COL_UZYTKOWNIK_LOGIN, $this->uzytkownik_login);
        }
        if ($this->isColumnModified(Lubie_toTableMap::COL_PRZEPIS_ID_PRZEPIS)) {
            $criteria->add(Lubie_toTableMap::COL_PRZEPIS_ID_PRZEPIS, $this->przepis_id_przepis);
        }
    ...
    {
        $criteria = ChildLubie_toQuery::create();
        $criteria->add(Lubie_toTableMap::COL_UZYTKOWNIK_LOGIN, $this->uzytkownik_login);
        $criteria->add(Lubie_toTableMap::COL_PRZEPIS_ID_PRZEPIS, $this->przepis_id_przepis);
    ...
    public function hashCode()
    {
        ...
        //relation lubie_to_fk_0ae17c to table uzytkownik
        ...
        //relation lubie_to_fk_1dec01 to table przepis
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Lubie_to (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Lubie_to Clone of current object.
     * @throws PropelException
     */
    ...
    public function getUzytkownik(ConnectionInterface $con = null)
    {
        if ($this->aUzytkownik === null && (($this->uzytkownik_login !== "" && $this->uzytkownik_login !== null))) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUzytkownik->addLubie_tos($this);
             */
        }
    ...
    public function getPrzepis(ConnectionInterface $con = null)
    {
        if ($this->aPrzepis === null && ($this->przepis_id_przepis != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPrzepis->addLubie_tos($this);
             */
        }
    ...
    {
        if (null !== $this->aUzytkownik) {
            $this->aUzytkownik->removeLubie_to($this);
        }
        if (null !== $this->aPrzepis) {
            $this->aPrzepis->removeLubie_to($this);
        }
    ...
    {
        return (string) $this->exportTo(Lubie_toTableMap::DEFAULT_STRING_FORMAT);
    }
