 ...
 */
abstract class Uzytkownik implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\UzytkownikTableMap';
    ...
    /**
     * The value for the rodzaj_konta field.
     *
     * @var        int
     */
    protected $rodzaj_konta;

    /**
     * The value for the status_konta field.
     *
     * @var        int
     */
    protected $status_konta;
    ...
    /**
     * Compares this with another <code>Uzytkownik</code> instance.  If
     * <code>obj</code> is an instance of <code>Uzytkownik</code>, delegates to
     * <code>equals(Uzytkownik)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    /**
     * Get the [rodzaj_konta] column value.
     *
     * @return int
     */
    public function getRodzajKonta()
    {
        return $this->rodzaj_konta;
    }

    /**
     * Get the [status_konta] column value.
     *
     * @return int
     */
    public function getStatusKonta()
    {
        return $this->status_konta;
    }
    ...
    public function setLogin($v)
    {
        ...
        if ($this->login !== $v) {
            $this->login = $v;
            $this->modifiedColumns[UzytkownikTableMap::COL_LOGIN] = true;
        }
    ...
    public function setNazwa($v)
    {
        ...
        if ($this->nazwa !== $v) {
            $this->nazwa = $v;
            $this->modifiedColumns[UzytkownikTableMap::COL_NAZWA] = true;
        }
    ...
    public function setHaslo($v)
    {
        ...
        if ($this->haslo !== $v) {
            $this->haslo = $v;
            $this->modifiedColumns[UzytkownikTableMap::COL_HASLO] = true;
        }
    ...
    /**
     * Set the value of [rodzaj_konta] column.
     *
     * @param int $v New value
     * @return $this|\Uzytkownik The current object (for fluent API support)
     */
    public function setRodzajKonta($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->rodzaj_konta !== $v) {
            $this->rodzaj_konta = $v;
            $this->modifiedColumns[UzytkownikTableMap::COL_RODZAJ_KONTA] = true;
        }
    ...
    /**
     * Set the value of [status_konta] column.
     *
     * @param int $v New value
     * @return $this|\Uzytkownik The current object (for fluent API support)
     */
    public function setStatusKonta($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->status_konta !== $v) {
            $this->status_konta = $v;
            $this->modifiedColumns[UzytkownikTableMap::COL_STATUS_KONTA] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : UzytkownikTableMap::translateFieldName('Login', TableMap::TYPE_PHPNAME, $indexType)];
            $this->login = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : UzytkownikTableMap::translateFieldName('Nazwa', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nazwa = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : UzytkownikTableMap::translateFieldName('Haslo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->haslo = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : UzytkownikTableMap::translateFieldName('RodzajKonta', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rodzaj_konta = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : UzytkownikTableMap::translateFieldName('StatusKonta', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status_konta = (null !== $col) ? (int) $col : null;
            $this->resetModified();
            ...
            return $startcol + 5; // 5 = UzytkownikTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Uzytkownik'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildUzytkownikQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Uzytkownik::setDeleted()
     * @see Uzytkownik::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildUzytkownikQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                UzytkownikTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UzytkownikTableMap::COL_LOGIN)) {
            $modifiedColumns[':p' . $index++]  = 'login';
        }
        if ($this->isColumnModified(UzytkownikTableMap::COL_NAZWA)) {
            $modifiedColumns[':p' . $index++]  = 'nazwa';
        }
        if ($this->isColumnModified(UzytkownikTableMap::COL_HASLO)) {
            $modifiedColumns[':p' . $index++]  = 'haslo';
        }
        if ($this->isColumnModified(UzytkownikTableMap::COL_RODZAJ_KONTA)) {
            $modifiedColumns[':p' . $index++]  = 'rodzaj_konta';
        }
        if ($this->isColumnModified(UzytkownikTableMap::COL_STATUS_KONTA)) {
            $modifiedColumns[':p' . $index++]  = 'status_konta';
        }

        $sql = sprintf(
            'INSERT INTO uzytkownik (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'nazwa':
                        ...
                        break;
                    case 'haslo':
                        $stmt->bindValue($identifier, $this->haslo, PDO::PARAM_STR);
                        break;
                    case 'rodzaj_konta':
                        $stmt->bindValue($identifier, $this->rodzaj_konta, PDO::PARAM_INT);
                        break;
                    case 'status_konta':
                        $stmt->bindValue($identifier, $this->status_konta, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = UzytkownikTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 2:
                ...
                break;
            case 3:
                return $this->getRodzajKonta();
                break;
            case 4:
                return $this->getStatusKonta();
                break;
            default:
                return null;
                break;
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Uzytkownik'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Uzytkownik'][$this->hashCode()] = true;
        $keys = UzytkownikTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getLogin(),
            $keys[1] => $this->getNazwa(),
            $keys[2] => $this->getHaslo(),
            $keys[3] => $this->getRodzajKonta(),
            $keys[4] => $this->getStatusKonta(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 2:
                ...
                break;
            case 3:
                $this->setRodzajKonta($value);
                break;
            case 4:
                $this->setStatusKonta($value);
                break;
        } // switch()
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setLogin($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setNazwa($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setHaslo($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setRodzajKonta($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setStatusKonta($arr[$keys[4]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Uzytkownik The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UzytkownikTableMap::COL_LOGIN)) {
            $criteria->add(UzytkownikTableMap::COL_LOGIN, $this->login);
        }
        if ($this->isColumnModified(UzytkownikTableMap::COL_NAZWA)) {
            $criteria->add(UzytkownikTableMap::COL_NAZWA, $this->nazwa);
        }
        if ($this->isColumnModified(UzytkownikTableMap::COL_HASLO)) {
            $criteria->add(UzytkownikTableMap::COL_HASLO, $this->haslo);
        }
        if ($this->isColumnModified(UzytkownikTableMap::COL_RODZAJ_KONTA)) {
            $criteria->add(UzytkownikTableMap::COL_RODZAJ_KONTA, $this->rodzaj_konta);
        }
        if ($this->isColumnModified(UzytkownikTableMap::COL_STATUS_KONTA)) {
            $criteria->add(UzytkownikTableMap::COL_STATUS_KONTA, $this->status_konta);
        }
    ...
    {
        $criteria = ChildUzytkownikQuery::create();
        $criteria->add(UzytkownikTableMap::COL_LOGIN, $this->login);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setHaslo($this->getHaslo());
        $copyObj->setRodzajKonta($this->getRodzajKonta());
        $copyObj->setStatusKonta($this->getStatusKonta());
    ...
    /**
     * Gets an array of ChildPrzepis objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     * If this ChildUzytkownik is new, it will return
    ...
    /**
     * Sets a collection of ChildPrzepis objects related by a one-to-many relationship
    ...
    /**
     * Returns the number of related Przepis objects.
     *
    ...
    /**
     * Method called to associate a ChildPrzepis object to this object
     * through the ChildPrzepis foreign key attribute.
     *
    ...
    public function clear()
    {
        ...
        $this->nazwa = null;
        $this->haslo = null;
        $this->rodzaj_konta = null;
        $this->status_konta = null;
        $this->alreadyInSave = false;
        $this->clearAllReferences();
        $this->resetModified();
        $this->setNew(true);
    ...
    {
        return (string) $this->exportTo(UzytkownikTableMap::DEFAULT_STRING_FORMAT);
    }
