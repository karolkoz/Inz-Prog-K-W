...
/**
 * Base class that represents a row from the 'kategoria' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Kategoria implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\KategoriaTableMap';
    ...
    /**
     * Compares this with another <code>Kategoria</code> instance.  If
     * <code>obj</code> is an instance of <code>Kategoria</code>, delegates to
     * <code>equals(Kategoria)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setNazwa($v)
    {
        ...
        if ($this->nazwa !== $v) {
            $this->nazwa = $v;
            $this->modifiedColumns[KategoriaTableMap::COL_NAZWA] = true;
        }
    ...
    public function setOpis($v)
    {
        ...
        if ($this->opis !== $v) {
            $this->opis = $v;
            $this->modifiedColumns[KategoriaTableMap::COL_OPIS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : KategoriaTableMap::translateFieldName('Nazwa', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nazwa = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : KategoriaTableMap::translateFieldName('Opis', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = KategoriaTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Kategoria'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildKategoriaQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Kategoria::setDeleted()
     * @see Kategoria::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildKategoriaQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                KategoriaTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(KategoriaTableMap::COL_NAZWA)) {
            $modifiedColumns[':p' . $index++]  = 'nazwa';
        }
        if ($this->isColumnModified(KategoriaTableMap::COL_OPIS)) {
            $modifiedColumns[':p' . $index++]  = 'opis';
        }

        $sql = sprintf(
            'INSERT INTO kategoria (%s) VALUES (%s)',
    ...
    {
        $pos = KategoriaTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Kategoria'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Kategoria'][$this->hashCode()] = true;
        $keys = KategoriaTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getNazwa(),
            $keys[1] => $this->getOpis(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setNazwa($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setOpis($arr[$keys[1]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Kategoria The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(KategoriaTableMap::COL_NAZWA)) {
            $criteria->add(KategoriaTableMap::COL_NAZWA, $this->nazwa);
        }
        if ($this->isColumnModified(KategoriaTableMap::COL_OPIS)) {
            $criteria->add(KategoriaTableMap::COL_OPIS, $this->opis);
        }
    ...
    {
        $criteria = ChildKategoriaQuery::create();
        $criteria->add(KategoriaTableMap::COL_NAZWA, $this->nazwa);
    ...
    /**
     * Generic method to set the primary key (nazwa column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Kategoria (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Kategoria Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildKategoria is new, it will return
    ...
    {
        return (string) $this->exportTo(KategoriaTableMap::DEFAULT_STRING_FORMAT);
    }
